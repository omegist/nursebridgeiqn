  ...
  return (
    <div className="flashcard-background">
      <div className="container mx-auto py-10 px-4 flex flex-col min-h-[calc(100vh-8rem)]">
        ...
        >
            <Button variant="outline" className="bg-background/20 text-white border-white/50 hover:bg-background/40" onClick={() => router.push('/flashcards')}>
        ...
        <div className="flex-grow flex flex-col items-center justify-center">
          ...
          >
              <h1 className="text-4xl font-bold font-headline mb-2 text-white">{topic.name}</h1>
              <p className="text-slate-200">Card {currentIndex + 1} of {topic.cards.length}</p>
          ...
          >
              <Button variant="outline" size="lg" className="bg-background/20 text-white border-white/50 hover:bg-background/40" onClick={() => paginate(-1)}>
                  <ChevronLeft className="h-5 w-5" />
                  Prev
              </Button>
              <Button variant="outline" size="lg" className="bg-background/20 text-white border-white/50 hover:bg-background/40" onClick={() => setIsFlipped(!isFlipped)}>
                  Flip Card
              </Button>
              <Button variant="outline" size="lg" className="bg-background/20 text-white border-white/50 hover:bg-background/40" onClick={() => paginate(1)}>
                  Next
