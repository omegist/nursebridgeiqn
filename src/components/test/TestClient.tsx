...
export function TestClient({ test }: { test: Test }) {
  ...
  const handleSubmit = useCallback(() => {
    ...
    setTestDuration(test.timeLimitMinutes ? (test.timeLimitMinutes * 60) - time : time);
  ...
  }, [currentQuestionIndex, test.questions.length, setCurrentQuestionIndex, saveProgress, userAnswers]);
              ...
              <AlertDialogContent>
                <AlertDialogHeader>
                  ...
                  <AlertDialogDescription>
                    Your test will be graded, and you won't be able to change your answers.
                  </AlertDialogDescription>
                </AlertDialogHeader>
                <AlertDialogFooter>
