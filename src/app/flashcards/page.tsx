      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {flashcardTopics.map((topic, index) => (
          <motion.div
            ...
            className="flex"
          >
            <Card className="w-full flex flex-col justify-between rounded-2xl shadow-lg border border-border/20 hover:border-accent transition-all duration-300 group">
              <div>
